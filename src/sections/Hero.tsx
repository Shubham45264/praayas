      ...
      <div className="container-page grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-[1.05] tracking-tight">
            ...
            <span className="gradient-text">Prayaas Classes</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild size="lg" className="rounded-full text-white shadow-elegant" style={{ background: "var(--gradient-brand)" }}>
              <Link to="/contact">
        ...
        >
          <div className="relative rounded-3xl overflow-hidden shadow-elegant border border-border">
            <img src={heroImg} alt="Students learning at Prayaas Classes" width={1536} height={1152} className="w-full h-auto" />
          ...
          <motion.div
            ...
            className="absolute -left-4 sm:-left-8 top-10 glass rounded-2xl px-4 py-3 shadow-soft hidden sm:block"
          >
          ...
          <motion.div
            ...
            className="absolute -right-4 sm:-right-6 bottom-10 glass rounded-2xl px-4 py-3 shadow-soft hidden sm:block"
          >
