...
export const Route = createFileRoute("/signup")({
  ...
  head: () => ({
    meta: [
      { title: "Sign Up — Prayaas Academy" },
      { name: "description", content: "Create an account at Prayaas Academy." },
    ],
  }),
});
    ...
    <div className="min-h-screen flex items-center justify-center py-24 px-4 bg-background relative overflow-hidden">
      ...
      <Card className="w-full max-w-md shadow-elegant border-border/50 bg-card/80 backdrop-blur-md relative z-10">
        <CardHeader className="space-y-3 text-center pb-6">
          ...
          <CardDescription>
            Join Prayaas Academy and start your success journey today.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <Button type="button" variant="outline" className="w-full bg-background/50 hover:bg-background" onClick={handleGoogleSignup} disabled={loading}>
